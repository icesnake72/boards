...
flowchart TD
  ...
  COMMENT -.->|"목록이 커진 뒤"| PERF["단계16 DB-PERFORMANCE"]
  REDIS -.->|"TTL 캐시 후속 후보"| PERF
  PERF -.->|"측정-개선 루프 재적용"| SEARCH["단계17 POST-SEARCH"]
```
...
| 16 | [[DB-PERFORMANCE]] · [[DB-PERFORMANCE-LAB]] · [[DB-PERFORMANCE-WALKTHROUGH]] | DB 성능 — 인덱스·keyset 페이지네이션 (로드맵/실습/따라하기) | 완료 |
| 17 | [[POST-SEARCH]] · [[POST-SEARCH-LAB]] · [[POST-SEARCH-WALKTHROUGH]] | 게시글 검색 — FULLTEXT·ngram (설계/실습/따라하기) | 완료 |
...
| 배포 | [[FRONTEND-PAGINATION]] | 프론트 재편(React 단일화) + 하이브리드 페이지네이션 — caddy bind mount 사고 기록 포함 |
